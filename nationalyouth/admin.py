...
class AdminType_of_Account(admin.ModelAdmin):
    list_display = ['id','type_of_account','date_and_time']


class AdminParticulars_Head(admin.ModelAdmin):
    list_display = ['id','particular_head','date_and_time']


class AdminCollege_Name(admin.ModelAdmin):
    list_display = ['id','college_name','date_and_time']

class AdminCourse_Name(admin.ModelAdmin):
...
class AdminEmployee_Record_Type(admin.ModelAdmin):
    list_display = ['id','employee_record_type','date_and_time']

class AdminWork_Status(admin.ModelAdmin):
    list_display = ['id','work_status','date_and_time']

class AdminEmployee_Live_and_Leave_Status(admin.ModelAdmin):
    list_display = ['id','employee_live_and_leave_status','date_and_time']


class AdminWork_Assign_Office(admin.ModelAdmin):
    list_display = ['id','work_assign_office','date_and_time']

class AdminExam_Fees_Type(admin.ModelAdmin):
    list_display = ['id','exam_fees_type','date_and_time']

class AdminMark_Status(admin.ModelAdmin):
    list_display = ['id','mark_status','date_and_time']

class AdminResult_Status(admin.ModelAdmin):
    list_display = ['id','result_status','date_and_time']

class AdminAdd_on_College(admin.ModelAdmin):
    list_display = ['id','add_on_college_name','date_and_time']

class AdminMain_Course(admin.ModelAdmin):
    list_display = ['id','main_course_name','date_and_time']

class AdminInstitution_Status(admin.ModelAdmin):
    list_display = ['id','institution_status','date_and_time']

class AdminAmount_Status(admin.ModelAdmin):
    list_display = ['id','amount_status','date_and_time']

class AdminFee_Type(admin.ModelAdmin):
    list_display = ['id','fee_type','date_and_time']

class AdminNature_of_Leave(admin.ModelAdmin):
    list_display = ['id','nature_of_leave','date_and_time']

class AdminUser_Role(admin.ModelAdmin):
...
class AdminMark_List_Registration(admin.ModelAdmin):
...
class AdminAdd_on_Programme(admin.ModelAdmin):
...
class AdminApplication_for_Affliation(admin.ModelAdmin):
...
class AdminE_Office_Queue(admin.ModelAdmin):
    list_display = ['queue_number', 'file_subject', 'remark', 'approval_first_officer', 'approval_second_officer', 'date_and_time']


class AdminE_Employee_Record(admin.ModelAdmin):
    list_display = [
...
class AdminE_Office_File_Sanction(admin.ModelAdmin):
    list_display = [
        'docket_number',
        'employee_code',
        'employee_name',
...
class AdminE_employee_daily_work_statement(admin.ModelAdmin):
    list_display = ['employee_name', 'work_start_time', 'employee_code', 'work_end_time',
...
class AdminEmployee_Status(admin.ModelAdmin):
    list_display = ['employee_live_or_leave_status', 'employee_id_number', 'employee_name', 'date_and_time']


class AdminE_employee_leave_status(admin.ModelAdmin):
    list_display = ['employee_live_or_leave_status', 'employee_id_number', 'employee_name',
...
class AdminE_employee_live_status(admin.ModelAdmin):
    list_display = ["employee_live_or_leave_status", "employee_id_number", "employee_name", "nature_of_leave", "remark", "date", "status", "date_and_time"]


class AdminStaff_work_allotment(admin.ModelAdmin):
    list_display = ['work_assign_office', 'name_of_employee', 'work_start_date', 'work_start_time',
                    'work_name', 'upload_work', 'work_finishing_date', 'work_finishing_time',
                    'work_head_name', 'current_status', 'date_and_time']
    


class AdminAffiliated_Vocational_Training_College_Kerla(admin.ModelAdmin):
    list_display = ['district', 'college_name', 'affiliation_number', 'principal_id', 'current_status', 'college_type', 'date_and_time']


class AdminAdd_on_Programme_College_Affiliation_Kerla(admin.ModelAdmin):
    list_display = ['state', 'district', 'college_name', 'affiliation_number', 'principal_id', 'date_and_time']


class AdminAdd_on_Programme_College_Affiliation_Bangalore(admin.ModelAdmin):
    list_display = ['state', 'district', 'college_name', 'affiliation_number', 'principal_id', 'date_and_time']


class AdminVocational_Course(admin.ModelAdmin):
    list_display  = [
...
class AdminCertificate_Course(admin.ModelAdmin):
    list_display = ['course_name', 'duration', 'add_on_exam_fees', 'admission_fee_1', 'exam_fee_1',
                    'transcript_fee_1', 'total_fee_1', 'gst', 'remark', 'date_and_time']


class AdminDiploma_Programme(admin.ModelAdmin):
    list_display = ['course_name', 'duration', 'add_on_exam_fees', 'admission_fee_1', 'exam_fee_1', 'transcript_fee_1', 'total_fee_1', 'gst', 'remark', 'date_and_time']


class AdminPG_Diploma_Programme(admin.ModelAdmin):
    list_display = ['course_name', 'duration', 'add_on_exam_fees', 'admission_fee_1', 'exam_fee_1', 'transcript_fee_1',
